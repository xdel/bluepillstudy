...
#define	PML4_BASE	0xFFFFF6FB7DBED000//HostAddress 
#define	PDP_BASE	0xFFFFF6FB7DA00000
#define	PD_BASE		0xFFFFF6FB40000000
#define	PT_BASE		0xFFFFF68000000000
//实际上这四个内存地址设定是很有讲究的，因为开头是FFFF，所以保证了在48-bit addressing, 56-bit addressing, 64-bit addressing都适用
//关于这点参见http://en.wikipedia.org/wiki/X86-64
typedef NTSTATUS (
