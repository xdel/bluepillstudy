...
typedef struct
{
  ...
  uint64_t PIN_BASED_VM_EXEC_CONTROL;
  uint64_t CPU_BASED_VM_EXEC_CONTROL;
  ...
  uint64_t IDT_VECTORING_INFO_FIELD;
  ...
  uint64_t GUEST_SM_BASE;
  uint64_t GUEST_SYSENTER_CS;
  uint64_t HOST_IA32_SYSENTER_CS;
