...
0.4em\relax IIn order to support various ways to protect software,
for example, using \emph{Hardware-Virtual-Machine (HVM)} to
protect the application data  and OS kernel , HBSP supplies a rich
set of interfaces to configure VMCS (Virtual Machine Control
Structure) struct and memory strategy. When comes to the high
...
technology. We believe HBSP is a practical approach to protect
